    ...
    */
    ...
    public function submitForm(array &$form, FormStateInterface $form_state) {
        try {
            ...
            $fields['address'] = $field['student_address'];
            $fields['email'] = $field['student_mail'];
            $fields['phone_number'] = $field['student_phone'];
            $fields['date_of_birth'] = $field['student_dob'];
            ...
            \Drupal::messenger()->addMessage($ex->getMessage());
        }
    }
}